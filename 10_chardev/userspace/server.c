...
int main(int argc, char **argv) {
    ...
    while (1) {
        ...
        if (!strstr(uri, "cgi-bin")) { /* static content */
            ...
            if (NULL!=strstr(uri, "red=on")) { /* static content */
                printf("!!red=on \n");
            }
            else if (NULL!=strstr(uri, "red=off")) { /* static content */
                printf("!!red=off \n");
            }
            else if (NULL!=strstr(uri, "green=on")) { /* static content */
                printf("!!!green=on \n");
            }
            else if (NULL!=strstr(uri, "green=off")) { /* static content */
                printf("!!!green=off \n");
            }
            is_static = 1;
            strcpy(cgiargs, "");
